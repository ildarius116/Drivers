...
def set_result(data: dict, comment: dict, date: str) -> str:
    ...
    result_status = ""
    flags_str = data.get("PatologicFlag")
    patologic = ""
    par = 'xsi:nil="true"'
                    ...
                    <dev:SendResults>
                        <DeviceMessage xmlns="http://www.medrc.ru/DeviceExchange" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
                            <Data>
                                ...
                                <Probes>
                                    <ProbeNumber>{data.get('ProbeNumber')}</ProbeNumber>
                                    <SerialNumber>{data.get('SerialNumber')}</SerialNumber>
                                    <ProbeDate>{data.get('ProbeDate')}</ProbeDate>
                                    <CITO>{'false'}</CITO>
