...
from main.drivers.driver_proxy.drivers.mek_7300.handler_soap import create_soap
...
def main(semaphore: threading, data: bytes, analyzer_name: str, analyzer_number: str, port_parameters: dict):
    ...
    # elif analyzer_name in ('mek7300',):
    #     if results:
    #         # шаблон для формирования (отчета о результатах анализа последней полученной пробы
